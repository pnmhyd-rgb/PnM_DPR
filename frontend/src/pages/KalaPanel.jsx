...
function downloadPdf(tableData) {
  Promise.all([import('jspdf'), import('jspdf-autotable')])
    .then(([{ jsPDF }, { default: autoTable }]) => {
      ...
      doc.setFontSize(9)
      doc.text(`Generated by Ask Kala AI · ${new Date().toLocaleDateString('en-IN')}`, 14, 22)
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        background: 'linear-gradient(135deg, #2e1065 0%, #5b21b6 55%, #4f46e5 100%)',
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <div>
            <p style={{ color: '#ffffff', fontWeight: 800, fontSize: 15, letterSpacing: '0.01em' }}>Ask Kala</p>
            <p style={{ color: '#c4b5fd', fontSize: 10, fontWeight: 500 }}>The PnM Intelligence</p>
          </div>
        </div>
