          ...
          <table className="w-full text-xs">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-200">
                {['#','Project','SL No','Type','Manufacturer','Model','Capacity / UOM','Vendor','Reg No','Chassis No','Fuel Type','Shift','Meter','Fuel Min','Fuel Max','Planned Hrs/Day'].map(h => (
            ...
            <tbody className="divide-y divide-gray-100">
              ...
              {!loading && machines.length === 0 && <tr><td colSpan={16} className="px-4 py-10 text-center text-gray-400">No hire assets found</td></tr>}
